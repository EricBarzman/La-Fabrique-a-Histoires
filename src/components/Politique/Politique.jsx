...
function Politique() {
  return (
    <div id="politique">
      ...
      <p>
        Le site web La Fabrique à Histoires est détenu par La Fabrique à
        Histoires, qui est un contrôleur de données de vos données personnelles.
      </p>

      <p>
        Nous avons adopté cette politique de confidentialité, qui détermine la
        manière dont nous traitons les informations collectées par La Fabrique à
        Histoires, qui fournit également les raisons pour lesquelles nous devons
        ...
        d'utiliser le site web de La Fabrique à Histoires.
      </p>
      ...
      <p>
        Lorsque vous visitez le La Fabrique à Histoires, nous recueillons
      ...
      <p>
        ...
        contact@la-fabrique-a-histoires.com.
      </p>
      ...
      <h2>Utilisation d'images générées par IA :</h2>

      <p>
        Les images utilisées sur ce site web sont fournies par Canva
        (https://www.canva.com/policies/ai-product-terms/) et sont utilisées
        conformément à leurs conditions d'utilisation. La Fabrique à Histoires
        n'assume aucune responsabilité pour toute réclamation de droits d'auteur
        découlant de l'utilisation de ces images. Toute réclamation ou
        préoccupation concernant les droits d'auteur devrait être adressée à
        contact@la-fabrique-a-histoires.com. Nous nous engageons à respecter les
        droits de propriété intellectuelle et à résoudre tout différend de
        manière équitable et respectueuse.
      </p>
      ...
      <p>
        ...
        pouvez envoyer un courriel à contact@la-fabrique-a-histoires.com.
      </p>

      <em>générée via zyro.com pour projet école</em>
    </div>
  );
}
